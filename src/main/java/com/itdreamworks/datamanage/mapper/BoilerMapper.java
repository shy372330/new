...
public interface BoilerMapper {
    ...
    @Insert("INSERT into Boiler(customerId,BoilerNo,DeviceNo,BolierType,\n" +
            "BoilerTon,BoilerMedium,BoilerFuel,Status,SaleTime) VALUES(#{customerId},#{boilerNo},#{deviceNo},#{boilerType},\n" +
            "#{boilerTon},#{boilerMedium},#{boilerFuel},#{status},#{saleTime})")
    ...
    @Update("update Boiler set customerId=#{customerId},BoilerNo=#{boilerNo},DeviceNo=#{deviceNo},BolierType=#{boilerType},\n" +
            "BoilerTon=#{boilerTon},BoilerMedium=#{boilerMedium},BoilerFuel=#{boilerFuel},Status=#{status},SaleTime=#{saleTime})  ")
